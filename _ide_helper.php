...
namespace Yab\FormMaker\Facades { 
    ...
    class FormMaker {
        ...
        public static function setConnection($connection)
        {
            return \Yab\FormMaker\Services\FormMaker::setConnection($connection);
        }
         ...
         * @static 
         */ 
        public static function fromTable($table, $columns = null, $class = null, $view = null, $reformatted = true, $populated = false, $idAndTimestamps = false)
        {
            return \Yab\FormMaker\Services\FormMaker::fromTable($table, $columns, $class, $view, $reformatted, $populated, $idAndTimestamps);
        }
         ...
         * @static 
         */ 
        public static function fromArray($array, $columns = null, $view = null, $class = null, $populated = true, $reformatted = false, $timestamps = false)
        {
            return \Yab\FormMaker\Services\FormMaker::fromArray($array, $columns, $view, $class, $populated, $reformatted, $timestamps);
        }
         ...
         * @static 
         */ 
        public static function fromObject($object, $columns = null, $view = null, $class = null, $populated = true, $reformatted = false, $timestamps = false)
        {
            return \Yab\FormMaker\Services\FormMaker::fromObject($object, $columns, $view, $class, $populated, $reformatted, $timestamps);
        }
         ...
         * @static 
         */ 
        public static function cleanupIdAndTimeStamps($collection, $timestamps, $id)
        {
            return \Yab\FormMaker\Services\FormMaker::cleanupIdAndTimeStamps($collection, $timestamps, $id);
        }
        ...
        {
            return \Yab\FormMaker\Services\FormMaker::getFormErrors();
        }
         ...
         * @static 
         */ 
        public static function formContentBuild($field, $column, $input, $errorMessage)
        {
            return \Yab\FormMaker\Services\FormMaker::formContentBuild($field, $column, $input, $errorMessage);
        }
        ...
        {
            return \Yab\FormMaker\Services\FormMaker::getTableColumns($table, $allColumns);
        }
    ...
    class InputMaker {
         ...
         * @static 
         */ 
        public static function create($name, $config, $object = null, $class = null, $reformatted = false, $populated = true)
        {
            return \Yab\FormMaker\Services\InputMaker::create($name, $config, $object, $class, $reformatted, $populated);
        }
         ...
         * @static 
         */ 
        public static function getObjectValue($object, $name)
        {
            return \Yab\FormMaker\Services\InputMaker::getObjectValue($object, $name);
        }
         ...
         * @static 
         */ 
        public static function inputStringPreparer($config)
        {
            return \Yab\FormMaker\Services\InputMaker::inputStringPreparer($config);
        }
        ...
        {
            return \Yab\FormMaker\Services\InputMaker::label($name, $attributes);
        }
         ...
         * @static 
         */ 
        public static function prepareTheClass($class, $config)
        {
            return \Yab\FormMaker\Services\InputMaker::prepareTheClass($class, $config);
        }
        ...
        {
            return \Yab\FormMaker\Services\InputMaker::getInput();
        }
         ...
         * @static 
         */ 
        public static function prepareType($config)
        {
            return \Yab\FormMaker\Services\InputMaker::prepareType($config);
        }
         ...
         * @static 
         */ 
        public static function prepareObjectValue($config)
        {
            return \Yab\FormMaker\Services\InputMaker::prepareObjectValue($config);
        }
         ...
         * @static 
         */ 
        public static function getGeneratorMethod($type)
        {
            return \Yab\FormMaker\Services\InputMaker::getGeneratorMethod($type);
        }
...
namespace  { 
    ...
    class FormMaker extends \Yab\FormMaker\Facades\FormMaker {}

    class InputMaker extends \Yab\FormMaker\Facades\InputMaker {}

    class HTML extends \Collective\Html\HtmlFacade {}

    class Crypto extends \Yab\Crypto\Services\Crypto {}
